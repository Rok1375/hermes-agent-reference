# Category: delegating-to-ai-agents

> Deep-dive for the **1 skill** in the `delegating-to-ai-agents` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`delegating-to-ai-agents`](../skills/delegating-to-ai-agents/delegating-to-ai-agents.md) - Generic patterns for sending prompts to and polling output from other AI agents (Codex CLI, Claude Code, Pi Agent, OpenC
...
- **Author:** Hermes Agent
- **License:** MIT
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/delegating-to-ai-agents/SKILL.md`
