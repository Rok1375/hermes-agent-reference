...
> Deep-dive for the **1 skill** in the `yuanbao` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`yuanbao`](../skills/yuanbao/yuanbao.md) - Yuanbao (元宝) groups: @mention users, query info/members.
...
- **Name:** `yuanbao`
- **Version:** 1.0.0
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/yuanbao/SKILL.md`
