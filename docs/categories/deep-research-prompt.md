# Category: deep-research-prompt

> Deep-dive for the **1 skill** in the `deep-research-prompt` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`deep-research-prompt`](../skills/deep-research-prompt/deep-research-prompt.md) - Write a single-paragraph Deep Research prompt to hand to a human researcher or a deep-research AI. Use when the user wan
...
- **Author:** Hermes Agent
- **License:** MIT
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/deep-research-prompt/SKILL.md`
