...
> Deep-dive for the **1 skill** in the `computer-use` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`computer-use`](../skills/computer-use/computer-use.md) - |
...
- **Name:** `computer-use`
- **Version:** 2.0.0
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/computer-use/SKILL.md`
