# Category: agent-skill-authoring

> Deep-dive for the **1 skill** in the `agent-skill-authoring` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`agent-skill-authoring`](../skills/agent-skill-authoring/agent-skill-authoring.md) - How to write effective agent skills (SKILL.md) — anatomy, progressive disclosure, description-routing contract, design p
...
- **Author:** Hermes Agent
- **License:** MIT
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/agent-skill-authoring/SKILL.md`

**Description:**

> How to write effective agent skills (SKILL.md) — anatomy, progressive disclosure, description-routing contract, design patterns, anti-patterns, ship checklist. Use when the user says "create a skill", "improve this skill", "why isn't my skill triggering", or is editing a SKILL.md file.
