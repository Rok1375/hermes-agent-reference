...
> Deep-dive for the **1 skill** in the `prism-full` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`prism-full`](../skills/prism-full/prism-full.md) - Full Prism: multi-pass structural analysis with mandatory adversarial self-correction. Designs custom analytical passes,
...
- **Name:** `prism-full`
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/prism-full/SKILL.md`
