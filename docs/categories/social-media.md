...
> Deep-dive for the **1 skill** in the `social-media` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`xurl`](../skills/social-media/xurl.md) - X/Twitter via xurl CLI: post, search, DM, media, v2 API.
...
- **License:** MIT
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/social-media\xurl/SKILL.md`
