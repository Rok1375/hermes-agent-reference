# Category: video-presentation-review

> Deep-dive for the **1 skill** in the `video-presentation-review` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`video-presentation-review`](../skills/video-presentation-review/video-presentation-review.md) - Build and refine a video presentation slide-by-slide, alternating with the presenter. Covers the alternating explain/sho
