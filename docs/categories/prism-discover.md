# Category: prism-discover

> Deep-dive for the **1 skill** in the `prism-discover` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`prism-discover`](../skills/prism-discover/prism-discover.md) - Discover all possible analysis domains for an artifact. Finds obvious and non-obvious angles — architecture, security, b
...
- **Name:** `prism-discover`
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/prism-discover/SKILL.md`
