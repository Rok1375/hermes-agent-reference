...
> Deep-dive for the **1 skill** in the `prism-scan` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`prism-scan`](../skills/prism-scan/prism-scan.md) - Structural analysis through dynamically generated cognitive lenses. Generates the optimal analytical lens for the specif
...
- **Name:** `prism-scan`
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/prism-scan/SKILL.md`
