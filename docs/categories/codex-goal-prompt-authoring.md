# Category: codex-goal-prompt-authoring

> Deep-dive for the **1 skill** in the `codex-goal-prompt-authoring` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`codex-goal-prompt-authoring`](../skills/codex-goal-prompt-authoring/codex-goal-prompt-authoring.md) - Explain and write effective instructions for persistent self-checking agent loops (Codex /goal, or analogous long-runnin
...
- **Author:** Hermes Agent
- **License:** MIT
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/codex-goal-prompt-authoring/SKILL.md`

**Description:**

> Explain and write effective instructions for persistent self-checking agent loops (Codex /goal, or analogous long-running autonomous task loops with auto-continue). Use when the user mentions a long-running autonomous agent run, a goal loop, wants to kick off an overnight job, or asks how to write a goal prompt.
