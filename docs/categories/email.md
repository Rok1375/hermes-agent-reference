...
> Deep-dive for the **1 skill** in the `email` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`himalaya`](../skills/email/himalaya.md) - Himalaya CLI: IMAP/SMTP email from terminal.
...
- **Author:** community
- **License:** MIT
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/email\himalaya/SKILL.md`
