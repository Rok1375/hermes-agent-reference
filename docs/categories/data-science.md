...
> Deep-dive for the **1 skill** in the `data-science` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`jupyter-live-kernel`](../skills/data-science/jupyter-live-kernel.md) - Iterative Python via live Jupyter kernel (hamelnb).
...
- **Author:** Hermes Agent
- **License:** MIT
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/data-science\jupyter-live-kernel/SKILL.md`
