# Category: hermes-council-vps

> Deep-dive for the **1 skill** in the `hermes-council-vps` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`hermes-council-vps`](../skills/hermes-council-vps/hermes-council-vps.md) - Run a multi-agent LLM council on a Hetzner Ubuntu VPS using local Ollama models (no API key needed) plus optional OpenRo
