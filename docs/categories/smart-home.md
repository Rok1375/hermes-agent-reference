...
> Deep-dive for the **1 skill** in the `smart-home` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`openhue`](../skills/smart-home/openhue.md) - Control Philips Hue lights, scenes, rooms via OpenHue CLI.
...
- **Author:** community
- **License:** MIT
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/smart-home\openhue/SKILL.md`
