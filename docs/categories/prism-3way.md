...
> Deep-dive for the **1 skill** in the `prism-3way` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`prism-3way`](../skills/prism-3way/prism-3way.md) - Three orthogonal analytical operations (WHERE/WHEN/WHY) + cross-operation synthesis. Each operation attacks the problem 
...
- **Name:** `prism-3way`
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/prism-3way/SKILL.md`
