...
> Deep-dive for the **1 skill** in the `video-preproduction` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`video-preproduction`](../skills/video-preproduction/video-preproduction.md) - Video pre-production in two phases — (1) VET a tool/repo/product actually works before committing recording time, then (
