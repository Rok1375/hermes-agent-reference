# Category: prism-reflect

> Deep-dive for the **1 skill** in the `prism-reflect` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`prism-reflect`](../skills/prism-reflect/prism-reflect.md) - Constraint transparency: analyzes an artifact structurally, then analyzes what its own analysis concealed. Produces a co
...
- **Name:** `prism-reflect`
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/prism-reflect/SKILL.md`
