...
> Deep-dive for the **1 skill** in the `fable-mode` category. Each section embeds the full `SKILL.md` body so this doc is self-contained.

**Skills in this category:**

- [`fable-mode`](../skills/fable-mode/fable-mode.md) - Fable-style workflow discipline for all agent operations with user preference embedding
...
- **On-disk path:** `C:/Users/soren/AppData/Local/hermes/skills/fable-mode/SKILL.md`

**Description:**

> Fable-style workflow discipline for all agent operations with user preference embedding
